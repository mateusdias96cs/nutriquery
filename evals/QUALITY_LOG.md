...
>
> Última geração: 2026-07-17 17:11 · dataset `v2.0` · 21 perguntas
...
## O que precisa melhorar — rodada de 2026-07-17 16:46

| # | Dificuldade | Pergunta | Por que reprovou |
|---|---|---|---|
| Q004 | join_group | Qual semente tem maior cálcio em comparação com o leite e derivados? | cardinalidade: agente 10 vs gold 35 |
...
| Q015 | aggregation | Quais proteínas vegetais possuem maiores aminoácidos essenciais? | regra 11 por keyword |
| Q016 | join_group | Quais proteínas vegetais possuem menor teor de proteína em 100g? | coluna 'food_name' do gold não tem correspondente no agente com os mesmos valores |
| Q017 | aggregation | Quais proteínas vegetais possuem maior teor de proteína e baixo teor de carboidrato? | cardinalidade: agente 1 vs gold 10 |
| Q018 | simple_filter | Quais alimentos possuem maior quantidade de leucina? | regra 11 por keyword |
...
| # | Dificuldade | 06-26 | 06-28 | 07-16 | 07-17 |
|---|---|---|---|---|---|
| Q001 | simple_filter | ✅ | ✅ | ✅ | ✅ |
| Q002 | join_group | ✅ | ✅ | ✅ | ✅ |
| Q003 | aggregation | ❌ | ❌ | ✅ | ✅ |
